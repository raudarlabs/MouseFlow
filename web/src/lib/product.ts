...
export const SCREENS: Screen[] = [
  ...
  /* ДОКУМЕНТЫ - СВОЙ ПУНКТ, 2026-09-18 (§5.3 плана). Полка документов была вкладкой Галереи, и это было
   * верно, пока обе полки отвечали на один вопрос. Галерея распространяет ЧУЖИЕ опубликованные потоки;
   * документ - то, что человек написал сам и посылает коллеге. Два вопроса, два места. */
  { to: '/docs', label: 'Documents', title: 'Documents', owner: 'make', nav: true,
    tour: {
      title: 'Turn a recording into something people can read',
      body: 'A document is written from what you actually did — the steps, in order, in words. It is the '
  ...
  /* Ассистент - СНОВА ЭКРАН, но НЕ пункт меню (2026-09-18). Вопросы задают про числа, стоящие рядом, и
   * встроенная в дашборд панель остаётся главной дверью; второй пункт в меню вернул бы ровно ту беду, из-за
   * которой экран когда-то и убрали, - человек набирал заново окно, на которое уже смотрел. Маршрут при
   * этом живой: адрес был в ходу, а перенаправление на дашборд теперь уводит в другой продукт. */
